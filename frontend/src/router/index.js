...
import ReservationsAdminView from "../views/ReservationsAdminView.vue";
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "reservations", name: "reservations", component: ReservationsAdminView, meta: { requiresAdmin: true } }
    ]
  }
];
