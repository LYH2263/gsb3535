  ...
  <div class="page-container">
    <div class="view-header">
      <div class="header-content">
        ...
        <p class="view-subtitle">查看预约排队状态，管理图书预约记录</p>
      </div>
    </div>
    ...
    <div class="content-body">
      ...
      <div v-else-if="records.length === 0" class="empty-state">
        <el-empty description="暂无预约记录" :image-size="120">
          <el-button class="apple-btn primary" @click="$router.push('/books')">去浏览图书</el-button>
        </el-empty>
      </div>
...
const records = computed(() => store.getters["reservations/myReservations"]);
...
const handleCancel = (row) => {
  ElMessageBox.confirm(`确定取消预约《${row.bookTitle}》吗？取消后排队序号将自动调整。`, "取消预约", {
