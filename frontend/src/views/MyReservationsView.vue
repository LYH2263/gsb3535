  ...
  <div class="page-container">
    <div class="view-header">
      <div class="header-content">
        ...
        <p class="view-subtitle">查看您的排队预约情况</p>
      </div>
    </div>
    ...
    <div class="content-body">
      ...
      <div v-else>
        <el-empty v-if="!reservations || reservations.length === 0" description="暂无预约记录" />

        <div v-else>
          <!-- Desktop Table View -->
          <div class="table-card hidden-xs-only">
            <el-table :data="reservations" class="apple-table" row-class-name="apple-table-row">
              <el-table-column prop="queuePosition" label="排队序号" width="120" align="center">
              ...
              <el-table-column prop="bookTitle" label="图书名称" min-width="240">
                <template #default="{ row }">
            ...
            <div v-for="item in reservations" :key="item.id" class="reservation-mobile-card">
              <div class="card-header">
                <div class="book-info">
                  ...
                  <p class="queue-info">排队序号: <span class="queue-number-text">#{{ item.queuePosition }}</span></p>
                </div>
...
import { Notebook as IepNotebook } from "@element-plus/icons-vue";

const store = useStore();
const reservations = computed(() => store.getters["reservations/myItems"]);
